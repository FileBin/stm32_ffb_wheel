...
#define HID_LOGICAL_MINIMUM1(x) HID_LOGICAL_MINIMUM(1, x) 
#define HID_LOGICAL_MINIMUM2(x) HID_LOGICAL_MINIMUM(2, x) 

#define HID_LOGICAL_MAXIMUM1(x) HID_LOGICAL_MAXIMUM(1, x) 
#define HID_LOGICAL_MAXIMUM2(x) HID_LOGICAL_MAXIMUM(2, x) 

#define HID_PHYSICAL_MINIMUM(n, x) HID_ELEM(0x3, GLOBAL, n, x)
#define HID_PHYSICAL_MAXIMUM(n, x) HID_ELEM(0x4, GLOBAL, n, x)

#define HID_PHYSICAL_MINIMUM1(x) HID_PHYSICAL_MINIMUM(1, x) 
#define HID_PHYSICAL_MINIMUM2(x) HID_PHYSICAL_MINIMUM(2, x) 

#define HID_PHYSICAL_MAXIMUM1(x) HID_PHYSICAL_MAXIMUM(1, x) 
#define HID_PHYSICAL_MAXIMUM2(x) HID_PHYSICAL_MAXIMUM(2, x) 
...
#define HID_USAGE_MINIMUM1(x) HID_USAGE_MINIMUM(1, x) 
#define HID_USAGE_MINIMUM2(x) HID_USAGE_MINIMUM(2, x) 

#define HID_USAGE_MAXIMUM1(x) HID_USAGE_MAXIMUM(1, x) 
#define HID_USAGE_MAXIMUM2(x) HID_USAGE_MAXIMUM(2, x) 
